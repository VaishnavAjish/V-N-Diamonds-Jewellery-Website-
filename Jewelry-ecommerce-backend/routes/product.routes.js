...
// bulk import products from an Excel sheet
router.post('/bulk-import-excel', upload.single('file'), productController.bulkImportExcel);
// get all products
...
// dynamic sidebar filters (category, color, shape)
