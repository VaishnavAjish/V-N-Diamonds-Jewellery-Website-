...
const Footer = ({ style_2 = false, style_3 = false, primary_style = false }) => {
  ...
  const [contactInfo, setContactInfo] = useState({
    email: 'vipul@vndiamonds.com',
    phone: '+852-69731885',
    location: 'Suite D, 25/F, No. 8 \nHart Avenue, Tsim Sha Tsui\nKowloon, Hong Kong'
  });
    ...
    fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/settings/storefront`)
      ...
      .then(data => {
        if (data.success && data.data && data.data.contactInfo) {
          setContactInfo({
            email: data.data.contactInfo.email || contactInfo.email,
            phone: data.data.contactInfo.phone || contactInfo.phone,
            location: data.data.contactInfo.location || contactInfo.location,
          });
        }
      })
  ...
  return (
    <>
      <footer>
        <div className="tp-footer-area tp-footer-style-2 tp-footer-style-3 tp-footer-style-4 p-relative" style={{ backgroundColor: `#020202`, color: '#fff', overflow: 'hidden' }}>
                      ...
                      <div className="tp-footer-contact">
                        <div className="tp-footer-contact-item d-flex align-items-start" style={{ gap: '15px', marginBottom: '15px' }}>
                          <div className="tp-footer-contact-icon">
                            <span>
                              <i className="fas fa-phone-alt" style={{ color: '#cd9a5b', marginTop: '6px' }}></i>
                            </span>
                          </div>
                          <div className="tp-footer-contact-content">
                            <p style={{ margin: 0, lineHeight: '1.5' }}><a href={`tel:${contactInfo.phone}`}>{contactInfo.phone}</a></p>
                          </div>
                        </div>
                        <div className="tp-footer-contact-item d-flex align-items-start" style={{ gap: '15px', marginBottom: '15px' }}>
                          <div className="tp-footer-contact-icon">
                            <span>
                              <i className="fas fa-envelope" style={{ color: '#cd9a5b', marginTop: '6px' }}></i>
                            </span>
                          </div>
                          <div className="tp-footer-contact-content">
                            <p style={{ margin: 0, lineHeight: '1.5' }}><a href={`mailto:${contactInfo.email}`}>{contactInfo.email}</a></p>
                          </div>
                        </div>
                        <div className="tp-footer-contact-item d-flex align-items-start" style={{ gap: '15px', marginBottom: '15px' }}>
                          <div className="tp-footer-contact-icon">
                            <span>
                              <i className="fas fa-map-marker-alt" style={{ color: '#cd9a5b', marginTop: '6px' }}></i>
                            </span>
                          </div>
                          <div className="tp-footer-contact-content">
                            <p style={{ margin: 0, lineHeight: '1.5' }}><a href="https://www.google.com/maps/place/VN+Diamonds/@22.2981918,114.1721542,17z/data=!3m1!4b1!4m6!3m5!1s0x340401d21d96f2cf:0x768cc49597bbdb16!8m2!3d22.2981918!4d114.1747291!16s%2Fg%2F11jnc054vw!5m1!1e1?entry=ttu&g_ep=EgoyMDI1MDgyNS4wIKXMDSoASAFQAw%3D%3D" target="_blank" style={{ whiteSpace: 'pre-wrap' }}>{contactInfo.location}</a></p>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                  <div className="tp-footer-widget mb-50">
                    <div className="tp-footer-logo mb-20">
                      <Link href="/">
                        <Image src={logo} alt="logo" width={180} height={111} style={{ width: '150px', height: 'auto' }} />
                      </Link>
                    </div>
                    <h4 className="tp-footer-widget-title" style={{ fontSize: '18px', marginBottom: '15px', color: '#cd9a5b' }}>The Perfect Present for Your Partner</h4>
                    <div className="tp-footer-widget-content tp-footer-dark-theme-content">
                      ...
                      <div className="tp-footer-social-4 tp-footer-social">
                        <a href="https://www.facebook.com/vndiamonds/?locale=zh_HK" target="_blank" rel="noreferrer" style={{ backgroundColor: 'transparent', border: '1px solid rgba(255,255,255,0.2)', color: '#cd9a5b' }}>
                          <i className="fab fa-facebook-f"></i>
                        </a>
                        <a href="https://www.instagram.com/harenejewels?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noreferrer" style={{ backgroundColor: 'transparent', border: '1px solid rgba(255,255,255,0.2)', color: '#cd9a5b' }}>
                  ...
                  <div className="col-lg-6 col-md-12 text-center text-lg-end">
                    <div className="tp-footer-copyright">
                      <p style={{ color: '#aaa', marginBottom: '0' }}>
                        © Copyright {new Date().getFullYear()}. All Rights Reserved By <span style={{ color: '#000' }}>Harene.</span>
                      </p>
                    </div>
                  </div>
                </div>
