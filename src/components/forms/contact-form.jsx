...
const ContactForm = () => {
    ...
    const onSubmit = (data) => {
      if(data){
        ...
        window.location.href = `mailto:vipul@vndiamonds.com?subject=${subject}&body=${body}`;
        notifySuccess('Opening your email client...');
      }
      reset();
    };
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} id="contact-form">
      <div className="tp-contact-input-wrapper">
        ...
        <div className="tp-contact-input-box">
          <div className="tp-contact-input">
            <input {...register("email", { required: `Email is required!` })} name="email" id="email" type="email" placeholder="demo@mail.com" />
          </div>
          <div className="tp-contact-input-title">
