...
const JewelryCollectionBanner = ({ settings }) => {
  const collection = settings?.collectionBanner || {
    title: "Our finest jewelry",
    leftImg: thumb_bg,
    rightImg: collection_sm
  };
              ...
              <div className="col-xl-6 col-lg-6">
                <div className="tp-collection-thumb-wrapper-4 p-relative fix z-index-1" >
                  <div className="tp-collection-thumb-4 include-bg black-bg" 
                    style={{backgroundImage:`url(${getImgSrc(collection.leftImg)})`}}>
                  </div>
                  ...
                  <div className="tp-collection-hotspot-item tp-collection-hotspot-1">
                    ...
                    <div className="tp-collection-hotspot-content">
                      <h3 className="tp-collection-hotspot-title">Our Earring collections</h3>
                      <p>the jewellery types</p>
                    </div>
                  </div>
                  ...
                  <div className="tp-collection-hotspot-item tp-collection-hotspot-2">
                    ...
                    <div className="tp-collection-hotspot-content on-top">
                      <h3 className="tp-collection-hotspot-title">Our Necklace Collections</h3>
                      <p>the jewellery types</p>
                    </div>
                  </div>
                    ...
                    <div className="col-xl-6 col-lg-8">
                      <div className="tp-collection-item-4 text-center">
                        ...
                        <div className="tp-collection-thumb-banner-4 m-img">
                          <Link href="/shop">
                            {typeof collection.rightImg === 'string' ? <img src={getImgSrc(collection.rightImg)} alt="collection_sm img" style={{width:'100%'}}/> : <Image src={collection.rightImg} alt="collection_sm img" />}
                          </Link>
                        </div>
                        <div className="tp-collection-content-4">
                          <h3 className="tp-collection-title-4">
                            <Link href="/shop">{collection.title}</Link>
                          </h3>
