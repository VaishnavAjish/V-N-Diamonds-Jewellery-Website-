                      ...
                      <div className="tp-footer-contact">
                        <div className="tp-footer-contact-item d-flex align-items-start" style={{ gap: '15px', marginBottom: '15px' }}>
                          ...
                          <div className="tp-footer-contact-content">
                            <p style={{ margin: 0, lineHeight: '1.5' }}><a href="tel:+852-69731885">+852-69731885</a></p>
                          </div>
                        </div>
                        <div className="tp-footer-contact-item d-flex align-items-start" style={{ gap: '15px', marginBottom: '15px' }}>
                          <div className="tp-footer-contact-icon">
                          ...
                          <div className="tp-footer-contact-content">
                            <p style={{ margin: 0, lineHeight: '1.5' }}><a href="mailto:vipul@vndiamonds.com">vipul@vndiamonds.com</a></p>
                          </div>
                        </div>
                        <div className="tp-footer-contact-item d-flex align-items-start" style={{ gap: '15px', marginBottom: '15px' }}>
                          <div className="tp-footer-contact-icon">
                          ...
                          <div className="tp-footer-contact-content">
                            <p style={{ margin: 0, lineHeight: '1.5' }}><a href="https://www.google.com/maps/place/VN+Diamonds/@22.2981918,114.1721542,17z/data=!3m1!4b1!4m6!3m5!1s0x340401d21d96f2cf:0x768cc49597bbdb16!8m2!3d22.2981918!4d114.1747291!16s%2Fg%2F11jnc054vw!5m1!1e1?entry=ttu&g_ep=EgoyMDI1MDgyNS4wIKXMDSoASAFQAw%3D%3D" target="_blank">Suite D, 25/F, No. 8 Hart Avenue<br />Tsim Sha Tsui, Kowloon, Hong Kong</a></p>
                          </div>
                        </div>
                      </div>
                    </div>
