                  ...
                  <div className="tp-header-action d-flex align-items-center justify-content-end ml-50">
                    ...
                    <div className="tp-header-login d-none d-lg-block ml-30 position-relative">
                      <div className="d-flex align-items-center">
                        {userInfo?.imageURL ? (
                          <a onClick={() => { setIsDropdownOpen(!isDropdownOpen); setShowLogoutConfirm(false); }} className="cursor-pointer" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '40px', height: '40px', borderRadius: '50%', overflow: 'hidden', border: `1px solid ${sticky ? 'black' : 'white'}` }}>
                            <Image
                          ...
                          <a onClick={() => { setIsDropdownOpen(!isDropdownOpen); setShowLogoutConfirm(false); }} className="cursor-pointer" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '40px', height: '40px', borderRadius: '50%', border: `1px solid ${sticky ? 'black' : 'white'}`, color: sticky ? 'black' : 'white', textDecoration: 'none' }}>
