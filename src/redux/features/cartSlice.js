...
export const cartSlice = createSlice({
  ...
  reducers: {
    ...
    set_cart: (state, { payload }) => {
      ...
      setLocalStorage("cart_products", payload);
    },
  ...
  extraReducers: (builder) => {
    builder.addCase('auth/userLoggedOut', (state) => {
      state.cart_products = [];
      state.orderQuantity = 1;
      // Note: we can't easily call imported setLocalStorage here if we don't want to import it, but we already import it!
      // Wait, we need to clear local storage too.
